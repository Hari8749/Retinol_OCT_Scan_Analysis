...
# --- 3. Educational Disease Information ---
DISEASE_DATA = [
    {
        "class": "CNV",
        ...
        "causes": [
            ...
            "Inflammatory eye conditions (e.g., punctate inner choroidopathy)",
            "Genetic predisposition"
        ],
        "prevention_management": [
            "Regular eye exams (especially if high-risk)",
            "Adoption of the AREDS2 vitamin formula",
            "Regular self-monitoring with an Amsler grid"
        ],
        "medicines_treatments": [
            "Anti-VEGF injections (Aflibercept, Ranibizumab, Bevacizumab) – Primary treatment",
            "Photodynamic Therapy (PDT) – Used in select cases",
    ...
    },
    {
        ...
        "causes": [
            "Poorly controlled Type 1 or Type 2 Diabetes (high HbA1c levels)",
            "Hypertension (high blood pressure)",
            "High cholesterol levels",
            "Diabetic Nephropathy (kidney disease)"
        ],
        "prevention_management": [
            "Strict control of blood sugar (HbA1c levels)",
            "Manage blood pressure and cholesterol",
            "Regular comprehensive dilated eye exams"
        ],
        "medicines_treatments": [
            "Anti-VEGF injections (Ranibizumab, Aflibercept) – First line therapy",
            "Steroid injections (Dexamethasone implant, Fluocinolone implant)",
            "Laser photocoagulation (Focal or grid laser)"
        ]
    },
    {
        "class": "DRUSEN",
        ...
        "prevention_management": [
            ...
            "Eat a diet rich in green leafy vegetables (lutein, zeaxanthin)"
        ],
        "medicines_treatments": [
            "AREDS2 high-dose antioxidant and mineral supplements (only for intermediate/advanced stages)",
            "N/A (No medical intervention typically required for early stages)"
        ]
    },
    {
        "class": "NORMAL",
        ...
        "prevention_management": [
            ...
            "Schedule routine annual eye examinations (especially after age 40)",
            "Avoid smoking"
        ],
...
if os.path.exists(MODEL_PATH):
    ...
    print(f"WARNING: '{MODEL_PATH}' not found. Using random model weights.")
...
def predict_oct(image_bytes):
    ...
    disease_info = next((d for d in DISEASE_DATA if d['class'] == predicted_class), None)
...
@app.route('/')
def home():
    return "Flask ML Inference API is live."
